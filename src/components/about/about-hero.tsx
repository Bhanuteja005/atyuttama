                    ...
                    <div className="flex flex-col w-full z-10">
                        ...
                        <Container delay={0.1}>
                            <h2 className="text-balance !leading-[1.25] text-4xl md:text-6xl font-semibold tracking-tight text-center lg:text-left mt-6 w-full">
                                Building the Future <br className="hidden lg:inline-block" /> of Digital Innovation
                            </h2>
                        </Container>

                        <Container delay={0.2}>
                            <p className="text-base lg:text-lg text-muted-foreground text-center lg:text-left mt-4 max-w-2xl mx-auto lg:mx-0">
                                We're a team of passionate technologists and innovators dedicated to transforming ideas into exceptional digital experiences
                            </p>
                        </Container>
                        ...
                        <Container delay={0.3}>
                            <div className="hidden lg:flex flex-col gap-2 mt-6">
                                ...
                                <div className="flex items-center gap-2">
                                    <CheckCircle2Icon className="size-4 text-primary" />
                                    <span className="text-sm text-muted-foreground font-medium">
                                        Expert team across multiple technologies
                                    </span>
                                </div>
                            </div>
                        </Container>
