                    ...
                    <div className="flex flex-col items-start justify-start md:items-center md:justify-center">
                        ...
                        <Container delay={0.1} className="flex grow">
                            <h2 className="text-3xl md:text-4xl font-semibold text-left mt-4">
                                Experts in Digital Transformation and Innovation
                            </h2>
                        </Container>
                        <Container delay={0.3} className="mt-auto">
                            <div className="flex items-center gap-4">
                                ...
                                <p className="text-base md:text-lg text-muted-foreground text-left mt-2 max-w-2xl">
                                    We're a dedicated team of technology professionals passionate about creating exceptional digital solutions
                                </p>
                            </div>
                        </Container>
                    </div>
                    ...
                    <div className="flex flex-col gap-8">
                        <Container className="flex items-start gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-2 text-base text-neutral-400">
                                    Our journey is built on deep expertise across app development, AI, web technologies, and digital marketing solutions.
                                </div>
                            </div>
                        </Container>
                        <Container delay={0.1} className="flex items-start gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-2 text-base text-neutral-400">
                                    We stay ahead of technology trends, continuously evolving our skills and approaches to deliver cutting-edge solutions.
                                </div>
                            </div>
                        </Container>
                        <Container delay={0.2} className="flex items-start gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-2 text-base text-neutral-400">
                                    Every project is a partnership. We measure our success by the growth and achievements of our clients.
                                </div>
                            </div>
                        </Container>
                    </div>
